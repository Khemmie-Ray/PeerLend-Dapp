    ...
    <main className="">
        ...
        <div className='w-3/6 flex justify-end items-end flex-col mb-4'>
            <div>
                ...
                <input type="text" placeholder='email' className="rounded-lg w-[50%] px-4 py-2 bg-[#ffffff23] backdrop-blur-lg mb-4 outline-none"  />
                <button className="bg-purple py-2 px-4 rounded-lg text-[18px] w-[50%] mb-4">Verify &rarr;</button>
                </div>
            </div>
